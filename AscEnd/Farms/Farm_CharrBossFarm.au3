...
Func CharrBossFarm()
    ...
    If Not GetPartyDead() Then FirstGroup()
    If Not GetPartyDead() Then Grawl() ; Fight Grawl if they are there?
    If Not GetPartyDead() Then SecondGroup()
    If Not GetPartyDead() Then LeftCorner()
    If Not GetPartyDead() Then Bosses()
