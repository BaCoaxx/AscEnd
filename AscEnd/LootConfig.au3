...
Func InitLootSettingsGUI()
	...
	If $isPurpleSell Then GUICtrlSetState($Radio4, $GUI_CHECKED) Else GUICtrlSetState($Radio3, $GUI_CHECKED)
	If $isGoldSell Then GUICtrlSetState($Radio2, $GUI_CHECKED) Else GUICtrlSetState($Radio1, $GUI_CHECKED)
	If $isBlueSell Then GUICtrlSetState($Radio6, $GUI_CHECKED) Else GUICtrlSetState($Radio5, $GUI_CHECKED)
	If $isBlackSell Then GUICtrlSetState($Radio8, $GUI_CHECKED) Else GUICtrlSetState($Radio7, $GUI_CHECKED)
	If $isWhiteSell Then GUICtrlSetState($Radio12, $GUI_CHECKED) Else GUICtrlSetState($Radio11, $GUI_CHECKED)
	If $isOtherSell Then GUICtrlSetState($Radio10, $GUI_CHECKED) Else GUICtrlSetState($Radio9, $GUI_CHECKED)
	If $isPconsSell Then GUICtrlSetState($Radio14, $GUI_CHECKED) Else GUICtrlSetState($Radio13, $GUI_CHECKED)
	If $isCBagSell Then GUICtrlSetState($Radio16, $GUI_CHECKED) Else GUICtrlSetState($Radio15, $GUI_CHECKED)
	If $isCSalvSell Then GUICtrlSetState($Radio18, $GUI_CHECKED) Else GUICtrlSetState($Radio17, $GUI_CHECKED)
	If $isCollSell Then GUICtrlSetState($Radio20, $GUI_CHECKED) Else GUICtrlSetState($Radio19, $GUI_CHECKED)
EndFunc
